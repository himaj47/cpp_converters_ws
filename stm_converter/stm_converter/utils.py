...
def get_fields(pkg_name: str, path:str , name: str):
...
def find_context_pkg(typename: str, msg_interfaces=None, builtin_interfaces=None):
    ...
    Returns:
        -  ``tuple[str, str]``: (context_pkg of typename, path to msg file)
...
def process_non_primitives(typename: str, is_array=False, msg_interfaces=None, builtin_interfaces=None):
